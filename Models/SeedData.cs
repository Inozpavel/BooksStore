...
namespace BooksStore.Models
{
    public static class SeedData
    {
        ...
        {
            var repository = applicationBuilder.ApplicationServices.GetRequiredService<IStoreRepository>();
        ...
        public static void EnsureBooksAdded(IApplicationBuilder applicationBuilder)
        {
            ...
            if (repository.Books.Any() == false)
                repository.AddBooksRange(
                    new Book("Левша", 1300) {Author = new Author("Лесков Н. С."), Category = new Category("Повести")},
                    new Book("Мертвые души", 900)
                    {
                        Author = new Author("Гоголь Н. В."), Category = new Category("Поэмы")
                    },
                    new Book("Анна Каренина", 800)
                    {
                        Author = new Author("Толстой Л. Н."), Category = new Category("Романы")
                    },
                    new Book("У лукоморья дуб зелёный", 800)
                    {
                        Author = new Author("Пушкин А. С."), Category = new Category("Сказки")
                    },
                    new Book("Война и мир", 1000)
                    {
                        Author = new Author("Толстой Л. Н."), Category = new Category("Эпопеи")
                    },
                    new Book("Сказка о царе Салтане", 1200)
                    {
                        Author = new Author("Пушкин А. С."), Category = new Category("Сказки")
                    },
                    new Book("Шинель", 500) {Author = new Author("Гоголь Н. В."), Category = new Category("Повести")},
                    ...
                    new Book("Нос", 600) {Author = new Author("Гоголь Н. В."), Category = new Category("Повести")},
